...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="<?php echo PATH_ROOT ?>css/bootstrap.min.css" rel="stylesheet">
    ...
    <script src="<?php echo PATH_ROOT ?>js/funciones.js"></script>
    <script src="<?php echo PATH_ROOT ?>js/jqFunciones.js"></script>
    <script src="<?php echo PATH_ROOT ?>js/bootstrap.js"></script>
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            ?>
            <li><a href="javascript:void(0)" onclick="<?php echo Handler::asyncLoad("Client", APP_CONTENT_BODY, array(), true);?>"><i class="fa fa-crosshairs"></i> <?php echo showMessage("passients"); ?></a></li>
           <?php
			}
            ?>
